...
func (c *greeterClient) SayHello(ctx context.Context, in *flatbuffers.Builder,
	opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/flatbuffers.grpc.models.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayManyHellos(ctx context.Context, in *flatbuffers.Builder,
	opts ...grpc.CallOption) (Greeter_SayManyHellosClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/flatbuffers.grpc.models.Greeter/SayManyHellos", opts...)
	if err != nil {
		return nil, err
	}
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context,
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/flatbuffers.grpc.models.Greeter/SayHello",
	}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	ServiceName: "flatbuffers.grpc.models.Greeter",
